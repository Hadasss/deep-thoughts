...
const Signup = () => {
  ...
  // initialize our ADD_USER mutation with the useMutation() Hook
  ...
  const handleFormSubmit = async (event) => {
    ...
    try {
      ...
      // we pass the data from the form state object as variables for our addUser mutation function. Upon success, we destructure the data object from the response of our mutation and simply log it to see if we're getting our token.
